...
func (obj *_WxOauthMgr) WithExpires(expires *string) Option {
...
func (obj *_WxOauthMgr) GetFromExpires(expires *string) (results []*WxOauth, err error) {
...
func (obj *_WxOauthMgr) GetBatchFromExpires(expiress []*string) (results []*WxOauth, err error) {
