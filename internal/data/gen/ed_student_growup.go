...
// EdStudentGrowup 教务-学生档案-成长记录
type EdStudentGrowup struct {
...
func (m *EdStudentGrowup) TableName() string {
	return "ed_student_growup"
}

// EdStudentGrowupColumns get sql column name.获取数据库列名
var EdStudentGrowupColumns = struct {
	ID        string
	StudentID string
	Type      string
	Title     string
