...
// EdTeacherInfoKey 教务-教师档案-属性
type EdTeacherInfoKey struct {
...
func (m *EdTeacherInfoKey) TableName() string {
	return "ed_teacher_info_key"
}

// EdTeacherInfoKeyColumns get sql column name.获取数据库列名
var EdTeacherInfoKeyColumns = struct {
	ID         string
	MerchantID string
	ShopID     string
	Key        string
