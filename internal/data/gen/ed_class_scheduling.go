...
// EdClassScheduling 教务-班级-排课表
type EdClassScheduling struct {
...
func (m *EdClassScheduling) TableName() string {
	return "ed_class_scheduling"
}

// EdClassSchedulingColumns get sql column name.获取数据库列名
var EdClassSchedulingColumns = struct {
	ID         string
	MerchantID string
	ShopID     string
	ClassID    string
